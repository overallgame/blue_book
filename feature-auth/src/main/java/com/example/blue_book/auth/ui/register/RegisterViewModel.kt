...
import com.example.blue_book.auth.domain.usecase.RegisterUseCase
import com.example.blue_book.auth.domain.usecase.SendVerificationCodeUseCase
...
class RegisterViewModel @Inject constructor(
    ...
    private suspend fun requestVerificationCode() {
        ...
        runResult(
            ...
            onSuccess = {
                setState { copy(isLoading = false, message = "验证码已发送，请查收短信") }
            },
            onFailure = { throwable ->
    ...
    private suspend fun submitRegister() {
        ...
        runResult(
            ...
            onSuccess = {
                setState { copy(isLoading = false, password = "", confirmPassword = "", verificationCode = "") }
